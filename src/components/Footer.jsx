 ...
 */
import { ShieldCheck, Server, Phone, Mail, Award } from "lucide-react";
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-xs font-semibold text-slate-400">
              ...
              <li className="flex items-center gap-2">
                <Award className="w-3.5 h-3.5 text-[#F4C542]"/> Compilateur de
                Code Natif
              </li>
              <li className="flex items-center gap-2">
                <Server className="w-3.5 h-3.5 text-[#F4C542]"/> Validation
                Administrative
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-xs font-semibold text-slate-400">
              <li className="flex items-center gap-2">
                ...
                <span>administration@hightech.edu</span>
              </li>
              <li className="flex items-center gap-2">
                <Phone className="w-4 h-4 text-[#F4C542]"/>
                <span>+212 (0) 522 45 67 89</span>
              </li>
